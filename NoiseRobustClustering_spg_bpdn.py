...
# The data vector
im_tiles2d, im_tiles1d = return_tiles(noisy_image, tile_w)
...
approx_data2d, approx_image = visualise_approx(im_tiles1d, Spectral_cluster_indices)
